import json
import os
from src import kontakt_handler, email_config_controller
from tests.helper import event, extract_headers, extract_status_code, DEFAULT_TENANT_ID
...
def test_create_kontakt_send_email(lambda_context, kontakt_table, email_config_table):
    ...
    email_config_controller.create_email_config(DEFAULT_TENANT_ID, email_config_item)
